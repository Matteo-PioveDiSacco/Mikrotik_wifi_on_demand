...
I files contengono il codice da copiare ed incollare in una finestra terminale di RouterOS, non è possibile utilizzare il comando di RouteOS `/import` in quanto la formattazione del file presente su GitHub non è compatibile con il comando di importazione, si è preferito infatti mantenere una formattazione chiara e comprensibile a scapito dell'automatismo di importazione che viene agevolmente sostituito dalle operazioni di importazione alternative di seguito descritte:  
...
Ora sono stati creati tutti gli script necessari.  
